import {
  ...
  Maximize2, Monitor, MousePointer2, Palette, Play, Plus, Quote, Redo2, RotateCw, Scissors,
...
const ICONS: Record<string, LucideIcon> = {
  ...
  quote: Quote, "redo-2": Redo2, "rotate-cw": RotateCw, scissors: Scissors, search: Search, "skip-back": SkipBack,
